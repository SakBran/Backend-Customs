...
//   }
// };
// const ApproveExpireReport: React.FC = () => {
...
//       let fullUrl = url + '&status=Payment Block';
...
//         api={'BusinessRegistration/GetBlockedDetailApplication'}
//         displayData={[
//           'applicationNo',
//           'createdDate',
//           'approvedDate',
...
// export default ApproveExpireReport;
import React, { useReducer, useState } from 'react';
import { PaginationType } from 'src/Models/PaginationType';
import axiosInstance from 'src/app/services/AxiosInstance';
import { RegisteredTable } from 'src/app/components/Table/RegisteredBusinessTable';
...
const ApproveExpireReport: React.FC = () => {
  ...
  return (
    <>
      ...
      <ReportTable
        key={refreshData ? 'refresh' : 'initial'} // Key prop to force re-render
        api={'BusinessRegistration/GetPaymentBlockedDetailApplication'}
        displayData={[
          'applicationNo',
          'createdDate',
          'approvedDate',
