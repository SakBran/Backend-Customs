  ...
  const exportToExcel = () => {
    const dataToExport = Array.from(
      ...
      return {
        ...
        'Company Registration No': cells[2].innerText,
        'Business Name': cells[3].innerText,
        'Business Name Myanmar': cells[4].innerText,
        'Voucher No': cells[5].innerText,
        'Account Title Description': cells[6].innerText,
        'Amount': cells[7].innerText,
      };
    });
