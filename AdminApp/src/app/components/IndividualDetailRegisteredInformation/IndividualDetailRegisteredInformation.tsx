import './IndividualDetailRegisteredInformation.style.css';
import { Radio, UploadFile } from 'antd';
import GetCertificateIndividual from './IndividualDetailRegisteredInfoAPIAction';
...
const IndividualRegisteredInfo: React.FC = () => {
  ...
  return (
    <div className="p-5 ml-5 mr-5">
      ...
      <div className="text text-center mt-5 pyidaungsu">
        <Radio.Group value={'individual'}>
          <Radio value="company">
            <h6>ကုမ္ပဏီ (သို့မဟုတ်) စီးပွားရေးအဖွဲ့အစည်းအတွက် လျှောက်ထားရန်</h6>
          </Radio>
          <Radio value="individual" checked={true}>
...
export default IndividualRegisteredInfo;
