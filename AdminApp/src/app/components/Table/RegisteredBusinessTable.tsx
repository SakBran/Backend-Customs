...
import RegisteredAction from '../TableAction/RegisteredBusinessAction';
...
export const RegisteredTable: React.FC<PropsType> = ({
  displayData,
  api,
  fetch,
}) => {
        ...
        <table>
          ...
          <tbody>
            {data.data.map((row, index) => {
              ...
              const action = <td key={index + 'id'}>{row['id']}</td>;
